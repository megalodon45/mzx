...
echo -e "$green.........................................................."$NC
echo -e "               Autoscript Mod By ( AndroVpn )" | lolcat
echo -e "                    CONTACT TELEGRAM"$NC | lolcat
echo -e "                       @mzx45"$NC | lolcat
echo -e "                       @zx_vpn"$NC | lolcat
echo -e "$green.........................................................."$NC
...
VALIDITY() {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/megalodon45/izinvps/main/ip | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl https://raw.githubusercontent.com/megalodon45/izinvps/main/ip | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
clear
CLNAME=$(curl https://raw.githubusercontent.com/megalodon45/izinvps/main/ip | grep $MYIP | awk '{print $2}')
if [ $MYIP = $CLNAME ]; then
echo ""
fi
clear
...
REPO="https://raw.githubusercontent.com/megalodon45/mzx/main/"
CDNF="https://raw.githubusercontent.com/megalodon45/mzx/main"
